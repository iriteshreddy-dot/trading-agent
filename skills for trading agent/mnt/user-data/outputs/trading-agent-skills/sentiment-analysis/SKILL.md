...
- `references/news-sources.md` — API endpoints and scraping targets for Indian financial news
- `references/sentiment-scoring.md` — Detailed scoring rubric with examples
- `references/market-impact-patterns.md` — Historical patterns of how news types moved stocks
